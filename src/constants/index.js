...
export const HERO_CONTENT = `UI/UX Designer with a background in Software Engineering, experienced in creating user-friendly and visually engaging digital experiences. Skilled in wireframing, prototyping, and crafting responsive interfaces using tools like Figma, Canva, Adobe XD, Illustrator and Photoshop. Proficient in translating complex requirements into intuitive designs, focusing on user research, accessibility, and seamless interactions. Combining technical knowledge with a creative mindset, I design user-focused interfaces that are both attractive and functional.`;
